...
import HeroLight from '@/public/screenshots-light.png'
import HeroDark from '@/public/screenshots-dark.png'
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    The AI-ready for team communication
                                </TextEffect>
                                <TextEffect
                                    per="line"
                                    preset="fade-in-blur"
                                    ...
                                    className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        TailFlow organizas conversations into channels with threads, is realtime and uses AI to keep teams in sync.
                                </TextEffect>
